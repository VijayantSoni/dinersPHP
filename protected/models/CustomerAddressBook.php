 ...
 */
class CustomerAddressBook extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('address_type', 'length', 'max'=>9),
			array('address, admin_notes, add_date, modify_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customer_id, address, address_type, status, admin_notes, add_date, modify_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'orders' => array(self::HAS_MANY, 'Orders', 'delivery_address_id'),
		);
	}
	 ...
	 * @return CustomerAddressBook the static model class
	 */
