...
class Item extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('restaurant_id, category_id, name', 'required'),
			array('restaurant_id, category_id, is_veg, is_spicy, serving_time, delivery_available, status', 'numerical', 'integerOnly'=>true),
			array('price', 'numerical'),
			array('name, logo, pricing_detail', 'length', 'max'=>255),
			array('details, admin_notes, add_date, modify_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, restaurant_id, category_id, name, details, logo, is_veg, is_spicy, price, pricing_detail, serving_time, delivery_available, status, admin_notes, add_date, modify_date', 'safe', 'on'=>'search'),
		);
	}
