						...
						<div class="modal">
							...
							<div class="modal-overlay">
								<div class="modal-wrap row">
									<div class="colGLG-4 colGMD-12 modal-wrap-banner">
									...
									<div class="colGLG-8 colGMD-12 modal-wrap-form">
										<ul class="tabs">
									    <li class="colGLG-6">
								        ...
								        <form id="tab-content2" class="tab-content colGLG-12">
								          <input type="text" name="mobile" placeholder="Your mobile number" class="colGLG-5">
								          <input type="text" name="email" placeholder="Your email" class="colGLG-6">
								          <input type="password" name="password" placeholder="Your password" class="colGLG-12">
								          <div class="row">
									          <input type="radio" name="role" id="user" value="2" checked>
									          <label for="user" class="colGLG-6">Customer</label>
